...
int main(int argc, char * argv[])
{
   ...
   switch(os_type)
   {
       case OMagicType::UNKNOWN  : printf("unknown, or regular MSDOS\n"); break;
       case OMagicType::WIN3     : printf("Windows 3.1 or earlier\n");    break;
       case OMagicType::WIN95    : printf("Windows 95\n");                break;
       case OMagicType::WIN98    : printf("Windows 98\n");                break;
       case OMagicType::WINME    : printf("Windows ME\n");                break;
       case OMagicType::WINNT    : printf("Windows NT\n");                break;
       case OMagicType::WIN2000  : printf("Windows 2000\n");              break;
       case OMagicType::WINXP    : printf("Windows XP\n");                break;
       case OMagicType::WIN2003  : printf("Windows 2003\n");              break;
       case OMagicType::WINVISTA : printf("Windows Vista\n");             break;
       case OMagicType::WIN7     : printf("Windows Seven\n");             break;
       case OSTYPE_OS2      : printf("OS/2\n");                      break;
       case OMagicType::WARP     : printf("OS/2 Warp 3\n");               break;
       case OMagicType::DOSEMU   : printf("Linux DOSEMU\n");              break;
       case OMagicType::OPENDOS  : printf("Caldera OpenDOS\n");           break;
       case OMagicType::LINUX    : printf("Linux\n");                     break;
       case OMagicType::SUNOS    : printf("SunOS/Solaris\n");             break;
       case OMagicType::FREEBSD  : printf("FreeBSD\n");                   break;
       case OMagicType::NETBSD   : printf("NetBSD\n");                    break;
       case OMagicType::IRIX     : printf("IRIX\n");                      break;
       case OMagicType::DARWIN   : printf("Darwin\n");                    break;
       case OMagicType::QNX      : printf("QNX\n");                       break;
       case OMagicType::UNIX     : printf("Unknown Unix variant\n");      break;
       case OMagicType::BEOS     : printf("BeOS\n");                      break;
       case OMagicType::HAIKU    : printf("Haiku\n");                     break;
       case OMagicType::MACOS    : printf("MacOS\n");                     break;
       case OMagicType::MACOSX   : printf("MacOS X\n");                   break;
       case OMagicType::PSP      : printf("Psp\n");                       break;
       default : printf("?\n"); break;
   }
   printf("os_version          = %i\n", os_version);
